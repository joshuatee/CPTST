...
/// <reference path="lib.d/lib.es-api.d.ts" />
/// <reference path="lib.d/lib.es-api-ext.d.ts" />

declare var context: Context;

interface GetEntFields_Field { }

interface GetEnts_Field { }
...
interface Data {
    from?: string;
    from_ent?: Entity; //"P00MBAA"
    ent?: Entity; //"P00MBAA", same as "from_ent"???
    ents?: Array<Entity>;  // either ent or ents???
    click_handler?: boolean;

    marker_id?: string;  //"first marker"

    pos?: VectorPOS;
    rot?: VectorROT;
    linear?: VectorLinearVEL;
    angular?: VectorAngularVEL;
    gravity?: VectorGravity;

    display_name?: string;
    player?: string;
    owner_user?: string; //"a551e3a2e7d32b28", same as "from"???
}
...
interface State_Key extends Key { }

interface User extends Entity { }   //  << ---- ???

interface KeyName extends String { }

interface KeyValue { }

interface Customizers {
    //[index: number]: Customizer; ???
}

interface Callback { }

interface Callback_Data { }
...
interface Vector4D extends Vector { }
...
interface VectorLinearVEL extends Vector { }

interface VectorAngularVEL extends Vector { }

interface VectorGravity extends Vector { }
...
/**
  ...
  */
declare function broadcastMessage( obj: {
...
/**
  ...
  */
declare function channelListen( obj: {
...
/**
  ...
  * @param obj Argument Object describing the channel.
  */
declare function channelUnlisten( obj: {
...
/**
  ...
  */
declare function directMessage( obj: {
    ...
    data?: Data;
    /** Optional callback for delivery errors. */
    callback?: Callback;
    /** Optional arbitrary object provided to your callback. */
...
/**
  ...
  */
declare function dec( key: KeyName ): number;
...
/**
  ...
  */
declare function get( key: KeyName ): any/* KeyValue */; // << ---------------- ?????????
...
/**
  ...
  */
declare function getParam( key: KeyName ): Parameter; // Fix/check parameter values/types
...
/**
  ...
  */
declare function inc( key: KeyName ): number;
...
/**
  ...
  */
declare function set( key: KeyName, value: any ): void;
...
/**
  ...
  */
declare function setUnary( key: KeyName, op: string/* Operator */ ): any; //any?? Operator or string?
...
// Temporary state is similar to persistent state, except that it is not stored
// in the database.It is lost when the server restarts, but it is much faster
// to access and has a lower performance impact, and is therefore much more
// amenable to heavy use, such as for a sort of communication setup channel.

// Temporary state generally doesn't require a state key, though they can still
// be used for secure state if you provide one.

// Temporary state is still asynchronous, though you are less likely to run into
// race conditions than you would with persistent state.

// There is currently only one kind of temporary state.It is per-Build
// per-instance.So any state you store is accessible within the Build instance,
// but not accessible outside the Build, or in a different instance of the same
// Build.

/**
  * Calls a callback with the values associated with requested keys in
  * the Build's per-instance temporary state
  * -------------------------------------------
  ...
  */
declare function getBuildInstanceTempState( obj: {
    /** State key to access data. */
    state_key?: Parameter; // key or string) <<< -------- !!!
...
/**
  * Sets key/value pairs in the Build's per-instance temporary state.
  * -------------------------------------------
  * - All data is automatically segregated by Build and instance. Other Builds,
  * and other instances of the same Build, can not share state through this
  * function. Note that the draft and published versions of a Build are different
  * Builds for the purposes of this function.
  * - The data is not persistent. It will be lost when the server restarts.
  * - The state_key is optional, and if no default state_key has been set
  * (by setStateKeyDefault()), then the state can be accessed by all scripts.
  * - Setting data into temporary state is an asynchronous operation, but it is
  * significantly faster and less resource-intensive than the persistent state
  * operations like setGlobalState().
  * - If checked key/values do not match the existing state's key/values, the
  * existing state will not be changed, and the callback's context.data will
  ...
  */
declare function setBuildInstanceTempState( obj: {
    /** State key to access data. */
    state_key?: Parameter; // key or string) <<< -------- !!!
...
/**
  ...
  */
declare function setStateKeyDefault( state_key?: KeyName ): void;
...
/**
  * Places an object into the player entity's inventory
  * -------------------------------------------
  * - See Script Inventory for an overview of how inventory works
  * http://wiki.cloudparty.com/mediawiki/index.php?title=Script_Inventory
  * - The target entity must be a player, and you must have general permission
  * over them for this function to work.
  * - Adding an object that is already in the user's inventory replaces
  * the existing object.
  *   - For the purposes of this check, any version of the same asset (e.g. from
  * an older published Build, or when going from a draft to a published Build
  * that shares a Inventory State Key) is considered the same.
  * - Specifying a state_key is generally unncessary and should be avoided unless
  * you specifically want to ensure the item is only ever used in conjunction
  * with the Key.
  *
  * @param obj Argument Object describing the object to add and whom to give it to.
  */
declare function inventoryAdd( obj: {
    /** Player entity to give the object to. */
    ent: Entity/* Player? */;       //      << --------- ??????
    /** Name of Prefab param that specifies the object to give. */
    prefab: Parameter/* Prefab? */;     //   Prefab, Namme? ParameterTypes[11] ? << ------- ????
    /** Name of Key param that specifies the state_key associated with
      * the inventory being used. Generally should not be used. */
    state_key?: KeyName;  // Name, Parameter or Prefab ?????  << ---------------------- ????
    /** Whether the object should be granted permanently. */
    persist?: boolean
}): void;

/**
  * Removes the object calling this function from the player entity's inventory
  * -------------------------------------------
  * - See Script Inventory for an overview of how inventory works
  * http://wiki.cloudparty.com/mediawiki/index.php?title=Script_Inventory
  * - This function only works when called from an inventory script
  */
declare function inventoryRemove(): void;
...
/**
  ...
  */
declare function deleteProp( obj: Object, prop: string ): void; // undefined ???
...
/**
  ...
  * @param str String to parse.
  */
// declare function parseFloat(str: string): number;    // <<-- Duplicate overload signature for 'parseFloat'.
...
/**
  ...
  */
declare function randomInt( min: number /* integer */, max: number /* integer */
    ): number;
...
declare function getEntFields(
    obj: {
        ...
        fields: Array<GetEntFields_Field>; // << --------------------------------- ???? BAD
...
declare function getEnts(
    obj: {
        ...
        channel?: Channel;
        /** Fields to include in callback function's context.data. */
        fields?: Array<GetEnts_Field>; // << ---------------------------- ?????   BAD
    }
    ): void;
...
declare function spawn(
    obj: {
        ...
        angular?: VectorAngularVEL //another type?
        ...
        gravity?: VectorGravity; //another type?
...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//               *** Animation, Particles, Video and Sound ***                //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
...
declare function particleFlash( obj: {
    ...
    details?: {
        ...
        overrides?: {
            ...
            position?: VectorPOS;
            position_jitter?: Vector;
            position_radial_jitter?: Vector;
            velocity?: Vector;
            velocity_jitter?: Vector;
            velocity_radial_jitter?: Vector;
            accel?: Vector;
            accel_jitter?: Vector;
            adjust_depth?: Vector;
            //  - Color
            ...
            hue_time?: Vector;
            saturation?: Vector;
            saturation_jitter?: Vector;
            saturation_time?: Vector;
            value?: Vector;
            value_jitter?: Vector;
            value_time?: Vector;
            alpha?: Vector;
            ...
            alpha_time?: Vector;
            //  - Scale
            // (Setting y scale only works if "Scale Linked" is unchecked in
            // source particle)
            // scale_y_jitter: [number, number, number, number]
            scale_x?: Vector;
            scale_x_jitter?: Vector;
            scale_x_time?: Vector;
            scale_y?: Vector;
            scale_y_jitter?: Vector;
            scale_y_time?: Vector;
    ...
    kickstart?: boolean;
            ...
            flip_x?: boolean;
            flip_y?: boolean;
            velocity_radial_linked?: boolean;
...
/**
  * Starts a tracked video, which must be connected to a texture customizer on
  * a prefab.
  * -------------------------------------------
  * - An entity can host at most 4 simultaneous script-generated tracked
  * particle emitters, sound emitters, video
  * emitters, or labels, and 5 non-tracked (flashed/detached).
  * - max_distance should always be set larger than min_distance.
  * - Two of the same video source playing on different objects will be in
  * sync, they share the same video element.
  * Audio gain will be determined by the loudest one (usually closest)..
  *
  * @param obj Argument Object describing video to start.
  */
declare function videoStart(
    obj: {
        /** The video parameter to start. */
        video?: Parameter;
        /** The url for a stream (should be .webm or .mp4). */
        url?: Parameter;
        /** Object with optional parameters for the audio part of the video. */
        details?: {
            /** Multiplier for sound gain (volume). 0.0 is silent, 1.0 is full volume. */
            gain?: number;
            /** How quickly the sound gain falls off with distance Ex: 'linear' or
              * 'inverse'. */
            rolloff_type?: string;
            /** Distance at which sample should be at max volume. */
            min_distance?: number;
            /** Max distance at which sample can no longer be heard. */
            max_distance?: number;
            /** Max distance at which sample stops falling off. Meaningless if greater
              * than max_distance. */
            max_falloff_distance?: number
        };
        /** Handle to use for stopping video. See videoStop(). */
        handle?: string/* handle name */; //own type?
    }): void;

/**
  * Stops a tracked video by handle.
  * -------------------------------------------
  * - This function is synonomous with particleStop() and labelRemove() and
  * soundStop().
  *
  * @param handle Video to stop.
  */
declare function videoStop( handle: string/* handle name */): void; //own type?
...
/**
  * Gets your gravity.
  */
declare function getGravity(): VectorGravity;
...
/**
  ...
  */
declare function getVelAngular(): VectorAngularVEL;

/**
  * Gets angular velocity of the scripted item.
  */
declare function getVelLinear(): VectorLinearVEL;
...
declare function controllerCreate(
    obj: {
        ...
        texts?: Array<{
            ...
            message: string;   // Message or string???
        ...
        buttons?: Array<{
            ...
            data?: Data; // MessageData or simply Data
...
declare function controllerHTMLCreate( obj: {
    ...
    messagers?: Array<{
        ...
        /** Data to be sent along with the message when this element is
          * clicked (access with getMessageData()). */
        data?: any; // MessageData or simply Data???  << ----------------- OR any ?????????
...
/**
  ...
  *
  * @param label Argument Object describing the label and its parameters.
  */
declare function labelAdd( label: {
...
/**
  ...
  */
declare function getHandlerData( handler?: Handler ): Data;
...
/**
  * Returns the message object received by a handler
  */
declare function getMessageData( message?: Message ): Data;
...
/**
  ...
  */
declare function getTimerData( timer: Timer ): Data;
...
/**
  ...
  */
declare function handlerDestroy( name: string ): void;
...
/**
  ...
  */
declare function handlerSetDisabled( name: string, disabled?: boolean ): void;
...
/**
  ...
  */
declare function timerDestroy( name: string ): void;
...
/**
  ...
  */
declare function timerSetPaused( name: string, paused: boolean ): void;
