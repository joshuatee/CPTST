...
/**
  * Prerequisites.
  * -------------------------------------------
  * - This example script must have a parameter named "Key" of type "Key" that
  * contains a key that has been created in your library
  * - Add the example script to a prefab that is present in-world.
  *
  * Expected Result.
  * -------------------------------------------
  * - Clicking on the prefab will give you a count of users who have visited your island. It may give no result until
  * at least one person that is not the island owner has visited.
  *
  * Source.
  * -------------------------------------------
  * - https://wiki.cloudparty.com/wiki/Script_Examples/Visitor_Counter
  */
